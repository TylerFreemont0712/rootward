  ...
  private view({ id, state }: LoadedRun, replay?: ShardrunView["replay"]): ShardrunView {
    ...
    return {
      ...
      layer: {
        ...
        flavor: layer.flavor,
        backdrop: layer.backdrop,
        bossBackdrop: layer.boss_backdrop ?? layer.backdrop,
        ambience: layer.ambience,
        bossAmbience: layer.boss_ambience ?? layer.ambience,
        ...(layer.music !== undefined ? { music: layer.music } : {}),
        ...(layer.battle_music !== undefined ? { battleMusic: layer.battle_music } : {}),
        ...(layer.boss_music !== undefined ? { bossMusic: layer.boss_music } : {}),
      },

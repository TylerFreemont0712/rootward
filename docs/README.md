...
Living project documentation, created and maintained by the build sessions (see `AGENT.md` section 3).
...
| `RUNNERS.md` | The sandboxes and their safety rules |
| `PLANNER.md` | How expeditions are planned from the learner model |
| `proposals/` | Background proposals that were not built as written (`scripted-combat.md`) |

Still to come, as their milestones land: `AI.md` (M2) and `EXTENDING.md` (the contracts that live in
`ideas/solutions/plugin-architecture.md` until then).
